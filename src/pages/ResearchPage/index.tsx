...
const researchProjects: ResearchProject[] = [
  {
    ...
    description: 'Comprehensive meta-analysis exploring ethical AI integration and organizational transformation.',
  ...
  },
  {
    ...
    description: 'Advanced research on genetic algorithms and neural network optimization for adaptive learning systems.',
  ...
  },
  {
    ...
    description: 'Developing frameworks for interpreting and understanding AI model decisions using advanced attribution techniques.',
      ...
      <section className={styles.researchApproachSection}>
        ...
        <div className={styles.approachGrid}>
          <div className={styles.approachItem}>
            ...
            <p>
              Uniting experts from AI, ethics, cognitive science, and domain-specific 
              fields to drive holistic research and innovation.
            </p>
          </div>
          <div className={styles.approachItem}>
